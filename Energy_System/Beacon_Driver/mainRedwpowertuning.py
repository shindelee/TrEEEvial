...
while True:
    ...
    iref = vPID.controller(vout, vref) # produce a control signal that has a value between 0 and 40
    ...
    # PID for stability and conditional for power tunings
    
    if vin < 6.5 and vin >= 5.75:
        duty_ref += 10
        pwm.freq(freq - 15000)
    elif vin < 5.75 and vin >= 5:
        duty_ref += 15
        pwm.freq(freq - 20000)
    elif vin < 5 and vin >= 4:
        duty_ref += 22.5
        pwm.freq(freq-32500)
