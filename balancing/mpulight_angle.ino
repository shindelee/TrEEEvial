...
void Get_Angle() {
  ...
  curangle = -(mu * (preangle + gyroAngle) + (1 - mu) * (accangle)); // complementary filter
...
void loop() {
  ...
  // Execute Get_Angle function at the specified interval
  /*if (currentTime - lastAngleUpdateTime >= ANGLE_UPDATE_INTERVAL) {
