...
// assign bb_active_wall = ((x == left_wall | x == right_wall) & (y <= bottom_wall) & (y >= top_red)) | ((y == top_wall | y == bottom_wall) & (x <= right_wall) & (x >= left_wall));
...
// assign bb_active_wall = (x == left_wall) | (x == right_wall) | (y == top_wall) | (y == bottom_wall);
