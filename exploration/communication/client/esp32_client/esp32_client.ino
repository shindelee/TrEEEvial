...
//  String message1 = "{\"x\":\"" + String(x) + "\",\"y\":\"" + String(y) + "\",\"f\":\"" + String(f) + "\",\"l\":\"" + String(l) + "\",\"r\":\"" + String(r) + "\",\"red_x_min\":\"" + String(numbers[0]) + "\",\"red_y_min\":\"" + String(numbers[1]) + "\",\"red_x_max\":\"" + String(numbers[2]) + "\",\"red_y_max\":\"" + String(numbers[3]) + "\",\"blue_x_min\":\"" + String(numbers[4]) + "\",\"blue_y_min\":\"" + String(numbers[5]) + "\",\"blue_x_max\":\"" + String(numbers[6]) + "\",\"blue_y_max\":\"" + String(numbers[7]) + "\",\"yellow_x_min\":\"" + String(numbers[8]) + "\",\"yellow_y_min\":\"" + String(numbers[9]) + "\",\"yellow_x_max\":\"" + String(numbers[10]) + "\",\"yellow_y_max\":\"" + String(numbers[11])+ "\"}";
